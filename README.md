...
Следует отметить, что работа js-файлов веб-компонента плагина невозможна в каталоге самого плагина. Для этого необходимо скопировать файлы в базовую директорию сайта в каталог `webrot/js`.
